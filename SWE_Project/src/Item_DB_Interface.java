...
public class Item_DB_Interface {
	...
	{
		MySQLConnector.openConnection();
		String q = "select DISTINCT  brand from "+tableName+" where type='"+type+"' AND category ='"+category+"'";
		java.sql.ResultSet rs = MySQLConnector.executeQuery(q);
		if(rs == null)
		{		
	...
	{
		MySQLConnector.openConnection();
		String q = "select DISTINCT  type from "+tableName+" where category='"+category+"'";
		java.sql.ResultSet rs = MySQLConnector.executeQuery(q);
		if(rs == null)
		{	
			MySQLConnector.closeConnection();
	...
	{
		MySQLConnector.openConnection();
		String q = "select DISTINCT  category from "+tableName+"";
		java.sql.ResultSet rs = MySQLConnector.executeQuery(q);
		if(rs == null)
		{		
			MySQLConnector.closeConnection();
